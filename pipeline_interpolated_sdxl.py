        ...
        **kwargs,
        ...
        if guide_prompt is not None:
            ...
            if init == "linear":
                ...
                negative_prompt_embeds_target = torch.lerp(negative_prompt_embeds_start, negative_prompt_embeds_end, it)
                pooled_prompt_embeds_target = torch.lerp(pooled_prompt_embeds_start, pooled_prompt_embeds_end, it)
                negative_pooled_prompt_embeds_target = torch.lerp(negative_pooled_prompt_embeds_start, negative_pooled_prompt_embeds_end, it)
            else:
                ...
                negative_pooled_prompt_embeds_target = slerp(negative_pooled_prompt_embeds_start, negative_pooled_prompt_embeds_end, it)
        
        prompt_embeds = torch.cat([prompt_embeds_start, prompt_embeds_target, prompt_embeds_end], dim=0).to(device=device)
        negative_prompt_embeds = torch.cat([negative_prompt_embeds_start, negative_prompt_embeds_target, negative_prompt_embeds_end], dim=0).to(device=device)
        pooled_prompt_embeds = torch.cat([pooled_prompt_embeds_start, pooled_prompt_embeds_target, pooled_prompt_embeds_end], dim=0).to(device=device)
        negative_pooled_prompt_embeds = torch.cat([negative_pooled_prompt_embeds_start, negative_pooled_prompt_embeds_target, negative_pooled_prompt_embeds_end], dim=0).to(device=device)
        ...
        add_time_ids = add_time_ids.to(device).repeat(3, 1)
        negative_add_time_ids = negative_add_time_ids.to(device).repeat(3, 1)
