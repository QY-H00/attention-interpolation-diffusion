    ...
    def interpolate_single(
        ...
        **kwargs,
        ...
        if init == "linear":
            ...
            negative_image_embeds_target = torch.lerp(negative_image_embeds_start, negative_image_embeds_end, it)
        else:
            image_embeds_target = slerp(image_embeds_start, image_embeds_end, it)
            negative_image_embeds_target = slerp(negative_image_embeds_start, negative_image_embeds_end, it)

        image_embeds = torch.cat([image_embeds_start, image_embeds_target, image_embeds_end], dim=0).to(device=device)
